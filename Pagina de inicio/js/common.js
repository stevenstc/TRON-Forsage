...
params.container.cell.html(`<img src="`+SITE_URL+`img/icons/${params.eventsTypeIcon[event.type]}" alt="" class="alert-socket__img"> ${msg} <div data-elapse_time="${event.time1}" class="elapsedTime"></div>`)
